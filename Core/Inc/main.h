...
#define LV_HANDLER_Pin              GPIO_PIN_0
#define LV_HANDLER_GPIO_Port        GPIOC

#define REFR_AREA_Pin               GPIO_PIN_10
#define REFR_AREA_GPIO_Port         GPIOC

#define FLUSH_CB_Pin                GPIO_PIN_11
#define FLUSH_CB_GPIO_Port          GPIOC
